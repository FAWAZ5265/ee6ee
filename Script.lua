...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/ tft4t)  \n')
end
...
return sendMsg(arg.ChatID,arg.MsgID,"⇠ هييه مايمديك تقيد Owner  ") 
...
elseif UserID == "1634560089" or UserID == "60809019" then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ هييه مايمديك تقيد Owner  ") 
...
elseif UserID == 1634560089 or UserID == 60809019 then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ هييه مايمديك تطرد Owner ") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1634560089 or UserID == 60809019 then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ هييه مايمديك تحظر Owner  ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
return sendMsg(arg.ChatID,arg.MsgID,"⇠ هييه مايمديك تكتم مطور الاساسي ") 
elseif UserID == 1634560089 or UserID == 60809019 then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ هييه مايمديك تكتم Owner  ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
local text = "-*Source Lonly*"
local inline = {
{{text = '𝐀 𝐋 𝐎 𝐍 𝐄 ♪ ',url="https://t.me/C1CIC"}},
{{text = '𝑆𝑜𝑢𝑟𝑐𝑒 ',url="https://t.me/Nvvv2"}},
{{text = '𝐹𝑒𝑒𝑙𝑖𝑛𝑔 ♪ ',url="https://t.me/NvvvM"}},
}   
...
if not msg.SudoBase then return"⇠ هذا الامر يخص ( Owner  ) بس  \n" end
...
sendMsg(arg.chat_id_,arg.id_,'⇠ معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس لونلي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : فواز ",url="t.me/tft4t"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: فواز](t.me/tft4t)',nil,inline,msg.id_)
return false
end
...
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username
text = ⇠ اهلا عزيزي هاذي اوامر البوت 
— — —— — —— — —— — —
م1 - اوامر ادارة المجموعة 
م2 - اوامر الوضع 
م3 - اوامر التفعيل والتعطيل 
اوامر التسليه - لعرض التسليه 
السورس - لعرض سورس البوت 
الالعاب - لعرض العاب البوت 

للاستفسار ⇠ [𝐀 𝐋 𝐎 𝐍 𝐄 ♪](https://t.me/C1CiC)
༄
  ]]
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
...
msg.textmsg = ⇠ اهلا عزيزي هاذي اوامر البوت 
— — —— — —— — —— — —
م1 - اوامر ادارة المجموعة 
م2 - اوامر الوضع 
م3 - اوامر التفعيل والتعطيل 
...
return sendMsg(ChatID,MsgID,"⇠ هييه مايمديك تحظر Owner  ") 
end
if redis:sismember(boss..'bannedpv',UserID) then 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"⇠ معليش هذا الحساب محظور من سيرفرات حماية فواز ") end
